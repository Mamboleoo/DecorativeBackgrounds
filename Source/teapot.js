...
var objStr = document.getElementById('teapot.obj').innerHTML;
...
export default class Teapot
{
	constructor(gl,scale, del){
		...
		// this.vectorMovingLight = this.transform.getTranslate()
		// console.log(this.vectorMovingLight)
		// this.LightLocation = vec3.create();
		// // this.LightLocation = []
		// this.lightTransform = new Transform();
		// this.copyvector = vec3.create();
	...
	{		
		...
		// var lightArray = shader.uniform("LightPositions");
		// lightArray = [[1,2,3],[3,2,1],[1,4,5]];
		...
		//   console.log(this.transform.getTranslate())

		shader.setUniformMatrix4fv(
			worldInverseTransposeLocation,
			worldInverseTransposeMatrix);

		 this.gl.uniform4fv(colorLocation, [1, 0, 0, 1]); // green
 
		//  vec3.add(this.vectorMovingLight, [1,2,4], this.vectorMovingLight);

		var LightmovingVector = [100,200,0]
		// var copyVec = this.copyvector
		// vec3.add(copyVec,LightmovingVector,this.transform.getTranslate());
		...
		if(boundingBoxMinDistance < 2){
			...
			console.log("Violates Constraint: Teapot")
		...
		//  console.log(viewWorldPositionLocation)
