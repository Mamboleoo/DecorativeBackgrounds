...
var objStr = document.getElementById('cuboid.obj').innerHTML;
...
{
    constructor(gl, mouseX, mouseY, r, scale,del)
	{
		...
		// console.log(meshData.vertexNormals)
	...
	{		
		...
		if(boundingBoxMinDistance < 2){
			...
			console.log("Violates Constraint: Cuboid")
...
// 
		if(color == "green"){
			...
			var newcolor = new Float32Array([0.0,0.0,1.0,1.0]);
		}
